...
2. 学完这篇你能掌握：区域/合作商/点位三个页面的改造思路、嵌套对象属性展示、下拉选择替代输入框、查看详情功能
...
- `prop="region.regionName"` 嵌套对象属性需要后端返回嵌套结构
...
- 修改：`src/views/manage/region/index.vue` — 表格序号列改造、添加点位数列、新增查看详情功能
- 修改：`src/views/manage/partner/index.vue` — 搜索/表格/表单全面改造、添加查看详情功能、操作按钮顺序调整
- 修改：`src/views/manage/node/index.vue` — 搜索区域改为下拉选择、表格嵌套对象属性、表单下拉选择、地址改 textarea、新增查看详情
